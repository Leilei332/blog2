...
换到原生[[Emacs]]后，为了给[[org-mode]]配置一个比较好的环境，对Emacs进行了一番配置。
...
(scroll-bar-mode 0)
```
`menu-bar-mode`对初次上手Emacs非常有帮助，推荐手动<<.kbd M-x>>开启
---
...
```
---
本人默认喜欢把Emacs最大化，在[[org-mode一些配置]]中可以更改`dotspacemacs-maximized-at-startup`来自动最大化。原生Emacs可以用一个内置函数来最大化：
